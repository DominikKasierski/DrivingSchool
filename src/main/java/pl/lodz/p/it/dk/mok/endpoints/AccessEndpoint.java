...
public class AccessEndpoint extends AbstractEndpoint implements AccessEndpointLocal {
    ...
    public void addInstructorPermission(String login, CourseCategory courseCategory) throws BaseException {
        ...
        accessManager.addInstructorPermission(accountManager.findByLogin(login), courseCategory,
    ...
    public void removeInstructorPermission(String login, CourseCategory courseCategory) throws BaseException {
        InstructorAccessDto instructorAccess = accessManager.getInstructorAccess(login);
        verifyEntityIntegrity(instructorAccess);
        accessManager.removeInstructorPermission(accountManager.findByLogin(login), courseCategory,
                accountManager.findByLogin(getLogin()));
    }
}
